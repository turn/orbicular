 ...
 * 4. Add demo html
 */
angular.module('turn/turnOrbicular', ['turnOrbicularTemplate']).value('turnOrbicularOptions', {}).directive('turnOrbicular', [
  '$window',
  function (windowRef) {
    ...
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        circles.push(angular.element(element.children()[0]).children()[0]);
        circles.push(angular.element(element.children()[1]).children()[0]);
        circles = angular.element(circles);
        fix = angular.element(angular.element(element.children()[1]).children()[1]);
        console.log('fix', fix);
        ...
        setWidth();
        scope.$on('orb width', setWidth);
        // for programmatic resizing
        // Optionally resize
        ...
        scope.$watch('current', function (newValue) {
          newValue = newValue / scope.total * 180;
